...
const engTranslate = {
    ...
    contact: 'Contact:',
    prices: 'Prices:',
    singleRoom: 'The single room: 77,00 EUR + tourist tax of 1,65 EUR / per person, per night',
    doubleRoom: 'The double room: 90,00 EUR + tourist tax of 1,65 EUR / per person, per night',
    location: 'Location:',
    ...
    elafitiBooking: 'Please, let us know if you need help with booking this tour.',
    thingsToDo: 'Things to do',
    restaurantInDubrovnik: 'Restaurants in Dubrovnik:',
    qna: 'Q & A',
    rsvpQuestion: 'When should I RSVP?',
    rsvpAnswer: 'We would greatly appreciate it if you could kindly RSVP by',
    rsvpAnswer2: ' August 31, 2024',
    rsvpAnswer3:
        ". As our venue has limited capacity, your confirmation is incredibly important to ensure we can accommodate everyone. Without your response, we may regrettably assume you won't be attending and won't be able to reserve a seat for you.",
...
const hrvTranslate = {
    ...
    rsvpNoAttend: 'Ne potvrđuje dolazak',
    rsvpBus: 'Potvrđuje prijevoz autobusom',
    rsvpNoBus: 'Ne potvrđuje prijevoz autobusom',
    rsvpMeal: 'Molimo, navedite sve prehrambene restrikcije ili alergije.',
    submit: 'Potvrdi',
    ...
    ston: 'Ston i Mali Ston',
    stonDayTrip:
        'Uživajte u degustaciji vina, posjetite farmu kamenica, najstariju solanu u Europi i prošećite zidinama Stona.',
    stonBooking: 'Molimo, javite nam ako trebate pomoć pri rezervaciji ovog izleta.',
    elafitiIslands: 'Elafitski otoci',
    elafitiDayTrip: 'Cjelodnevni izlet brodom na Elafitske otoke.',
    ...
    rsvpAnswer3:
        '. Budući da prostor za svadbenu večeru ima ograničen kapacitet, Vaša potvrda dolaska nam je izuzetno važna. Bez potvrde Vašeg dolaska do 31. kolovoza 2024. pretpostavit ćemo da ne možete doći te Vam nećemo moći rezervirati mjesto za svadbenu večeru.',
    dressCodeQuestion: 'Postoji li dress code?',
    dressCodeAnswer:
        'Dress code za naš dan vjenčanja je formalan. Iako su temperature u Dubrovniku u listopadu prilično visoke (15 °C - 30 °C), preporučujemo da ponesete nešto za prebaciti preko (npr. sako) za vrijeme večere jer u Šišinim dubima navečer može biti prohladno.',
